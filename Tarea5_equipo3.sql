...
EXEC sp_serveroption @server = 'AZURE-BRENDA', @optname = 'rpc', @optvalue = 'true';
EXEC sp_serveroption @server = 'AZURE-BRENDA', @optname = 'rpc out', @optvalue = 'true';
...
EXEC sp_serveroption @server = 'MYSQL_ALAN', @optname = 'rpc', @optvalue = 'true';
EXEC sp_serveroption @server = 'MYSQL_ALAN', @optname = 'rpc out', @optvalue = 'true';

EXEC consultaDinamicaMorbilidad 
     @Conexion = N'AZURE-ALAN', 
     @Tabla = N'datoscovid_noroeste'
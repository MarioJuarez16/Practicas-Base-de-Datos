EXEC sp_serveroption 'AZURE-ALAN', 'rpc out', true;
EXEC sp_serveroption 'AZURE-ALAN', 'rpc', true;

--FORMATO DE TABLA DONDE SE GUARDAN LOS DATOS FRAGMENTADOS
EXEC('
CREATE TABLE [dbo].[datoscovid_suroeste](
...
--FORMATO DE FRAGMENTACION DE REGIONES
INSERT INTO OPENQUERY([AZURE-MARIO], 'SELECT * FROM bdd.dbo.datoscovid_centronorte')
SELECT *
FROM covidHistorico.dbo.datoscovid
WHERE ENTIDAD_RES IN (02, 03, 26, 25, 08);

INSERT INTO OPENQUERY([AZURE-ALAN], 'SELECT * FROM bdd.dbo.datoscovid_suroeste')
SELECT *
FROM covidHistorico.dbo.datoscovid
WHERE ENTIDAD_RES IN (12, 20);


INSERT INTO OPENQUERY([AZURE-ALAN], 'SELECT * FROM bdd.dbo.datoscovid_sureste')
SELECT *
FROM covidHistorico.dbo.datoscovid
WHERE ENTIDAD_RES IN (04, 23, 31, 27, 07);


bcp "select * FROM covidHistorico.dbo.datoscovid WHERE ENTIDAD_RES IN (04,23,31,27,07)" queryout "C:\Users\Alang\OneDrive\Documentos\IPN\7 SEMESTRE\BD DISTRIBUIDAS\se.csv" -c -t, -S "LAPTOP-D1ML1TLP\SQLEXPRESS" -U "Alan Olea" -P osopanda123
